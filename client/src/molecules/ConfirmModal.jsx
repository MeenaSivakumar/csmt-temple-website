...
export default function ConfirmModal() {
  const { open, title, message, onConfirm } = useSelector(selectConfirmModal)
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      <div className="bg-cream rounded-2xl shadow-2xl w-full max-w-md border border-gold-light animate-in fade-in zoom-in duration-200">
        <div className="p-6">
